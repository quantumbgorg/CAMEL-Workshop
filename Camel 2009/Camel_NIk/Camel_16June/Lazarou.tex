\title{DRIVEN ENTANGLEMENT FROM AN ATOM COUPLED TO A \mbox{RESERVOIR}}

\underline{C. Lazarou}$^1$, B. M. Garraway$^1$, L. Mazzola$^2$, J.
Piilo$^2$, S. Maniscalco$^2$ and K.-A. Suominen$^2$ \index{Lazarou
C} \index{Garraway B} \index{Mazzola L} \index{Piilo J}
\index{Maniscalco S} \index{Suominen K-A}
